    ...
    <div className="flex items-start justify-between gap-4 border-b border-border px-5 py-4">
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          {description && <DialogPrimitive.Description className="mt-1 text-[12.5px] leading-relaxed text-muted">{description}</DialogPrimitive.Description>}
        </div>
      </div>
  ...
  return (
    <div className="flex items-start justify-between gap-3 border-b border-border px-5 py-4">
      <div className="min-w-0">
        ...
        {subtitle && <DialogPrimitive.Description className="mt-1 truncate text-[12.5px] text-subtle">{subtitle}</DialogPrimitive.Description>}
      </div>
    ...
    <TooltipPrimitive.Root delayDuration={delay}>
      ...
      <TooltipPrimitive.Portal>
        <TooltipPrimitive.Content
          ...
          sideOffset={6}
          className={cn(
            'z-[90] max-w-[280px] rounded-lg border border-border bg-surface-overlay px-2.5 py-1.5 text-[11.5px] leading-snug text-foreground',
...
export function MenuLabel({ children }: { children: ReactNode }) {
  return <div className="px-2.5 py-1.5 text-[10px] font-semibold uppercase tracking-[0.12em] text-subtle">{children}</div>;
}
